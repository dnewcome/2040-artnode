...
BOM = [
    # ── ICs ────────────────────────────────────────────────────────────────────
    ("RP2354A",      "U1",           "QFN-60-1EP_7x7mm_P0.4mm",      "C41378174", 1, "Dual-core Cortex-M33/RISC-V MCU with 2MB flash-in-package", "Extended"),
    ...
    # ── Connectors ─────────────────────────────────────────────────────────────
    ("USB4125-GF-A",      "J1",      "USB_C_Receptacle_GCT_USB4125-xx-x_6P_TopMnt_Horizontal", "C165948", 1, "USB-C receptacle, through-hole + SMD", "Extended"),
    ("HR911105A",         "J2",      "RJ45_Hanrun_HR911105A_Horizontal", "C12074",  1, "RJ45 with integrated magnetics + LEDs",      "Extended"),
    ...
    # ── Crystals ────────────────────────────────────────────────────────────────
    ("12MHz 3225",        "Y1",      "Crystal_SMD_3225-4Pin",         "C9002",   1, "12MHz crystal for RP2354A XOSC, ±30ppm",     "Basic"),
    ...
    ("3.3uH",             "L2",      "L_0805_2012Metric",             "C25923",  1, "RP2354A internal buck regulator inductor",   "Basic"),
    ...
    ("10k",      "R7,R8,R14,R15,R16,R21,R22","R_0402","C25744",7,"Pull-up: CHRG,RUN,SPI,BTN"),
    ...
    ("33",       "R23", "R_0402", "C25105",  1, "RP2354A VREG_AVDD filter resistor"),
    ("1k",       "R24", "R_0402", "C11702",  1, "BOOTSEL series resistor on QSPI_SS"),

    # ── Passive – Capacitors ─────────────────────────────────────────────────────
    ("100nF 0402 X5R", "C4,C8,C32,C35,C37,C38,C39,C40,C41,C42,C43,C44,C45,C47,C48,C49,C50,C52",
                          "C_0402", "C14663",  18, "100nF 0402 bypass caps"),
    ("12pF 0402 C0G", "C2,C3",  "C_0402",  "C1525",   2, "12MHz crystal load caps"),
    ("18pF 0402 C0G", "C5,C6",  "C_0402",  "C1810",   2, "25MHz crystal load caps"),
    ("4.7uF 0402 X5R","C7,C9,C10,C46,C51",    "C_0402",  "C19712",  5, "RP2354A regulator and W5500 bulk bypass"),
    ...
    # ── Switches ─────────────────────────────────────────────────────────────────
    ("KSC741J",  "SW1,SW2,SW3,SW4","SW_Push_1P1T_NO_CK_KSC7xxJ", "C318884", 4, "Tactile switch: BTN1, BTN2, RESET, BOOTSEL"),
]
